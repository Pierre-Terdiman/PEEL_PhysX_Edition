...
//				IceCheckBox*	mCheckBox_RCArticulations;
...
//									mCheckBox_RCArticulations		(null),
...
static const char* gDesc_SwingSet_Regular = "(Configurable test) - a test inspired by a swing set. We all did that on the playground as kids!... This is not \
...
static const char* gDesc_Crane_Regular = "(Configurable test) - Crane test. This variation uses regular joints and the TGS solver in PhysX 4.0, \
but it remains challenging without articulations. Running it side-by-side with PhysX 3.x shows clear improvements though.";
...
static const char* gDesc_ArticulationDriveTest = "(Configurable test) - Articulation drive test. This one is mainly to get a feeling for the MC articulation drive \
