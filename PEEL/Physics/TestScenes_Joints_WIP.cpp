...
//		ConvexCreate->mRenderer	= CreateConvexRenderer(ConvexCreate->mNbVerts, ConvexPts);
		...
		if(!ObjectDesc.mShapes)
			ObjectDesc.mShapes	= ConvexCreate;
		else
			SC->mNext = ConvexCreate;
		SC = ConvexCreate;
...
//		PINT_SPHERE_CREATE ShapeCreate((BigRadius - SmallRadius)*1.1f);
		...
		PINT_OBJECT_CREATE ObjectDesc;
		ObjectDesc.mShapes		= &ShapeCreate;
		ObjectDesc.mMass		= mass;
		ObjectDesc.mPosition	= torus_pos;
...
/*			Desc.mSpringStiffness	= 400.0f;
			Desc.mSpringDamping		= 10.0f;
				...
				Desc.mSpringDamping		= 100.0f;
					...
					Desc.mSpringDamping		= 1000.0f;*/
			Desc.mSpringStiffness	= stiffness;
			Desc.mSpringDamping		= damping;
		}
...
//		ConvexCreate->mRenderer	= CreateConvexRenderer(ConvexCreate->mNbVerts, ConvexPts);
		...
		if(!mObjectDesc.mShapes)
			mObjectDesc.mShapes	= ConvexCreate;
		else
			SC->mNext = ConvexCreate;
		SC = ConvexCreate;
	}
...
static const char* gDesc_MultiBodyVehicle = ".";
...
//		PintJointHandle		mWheelJoints[MAX_NB_WHEELS];
		...
		Wheel				mWheel[MAX_NB_WHEELS];
			...
			IceCheckBox*	mCheckBox_AttachCar;
			IceCheckBox*	mCheckBox_AttachWheels;
			IceCheckBox*	mCheckBox_AttachSteering;
			IceCheckBox*	mCheckBox_UseRCA;
			IceCheckBox*	mCheckBox_UseAggregates;
			IceCheckBox*	mCheckBox_TweakWheelsInertia;

			IceEditBox*		mEditBox_GlobalScale;
			IceEditBox*		mEditBox_CameraUpOffset;
			IceEditBox*		mEditBox_CameraDistToTarget;

			IceEditBox*		mEditBox_ChassisWidth;
			IceEditBox*		mEditBox_ChassisHeight;
			IceEditBox*		mEditBox_ChassisLength;
			IceEditBox*		mEditBox_ChassisMass;
			IceEditBox*		mEditBox_ChassisCOMOffsetX;
			IceEditBox*		mEditBox_ChassisCOMOffsetY;
			IceEditBox*		mEditBox_ChassisCOMOffsetZ;
			IceEditBox*		mEditBox_MassElements;
			IceEditBox*		mEditBox_ChassisFriction;

			IceEditBox*		mEditBox_WheelMass;
			IceEditBox*		mEditBox_WheelFrontFriction;
//			IceEditBox*		mEditBox_WheelRearFriction;
			IceEditBox*		mEditBox_WheelRadius;
			IceEditBox*		mEditBox_WheelWidth;
			IceEditBox*		mEditBox_WheelTessR;
			IceEditBox*		mEditBox_WheelTessW;

			IceEditBox*		mEditBox_SteerStiffness;
			IceEditBox*		mEditBox_SteerDamping;
			IceEditBox*		mEditBox_SteerLimitAngle;

			IceEditBox*		mEditBox_EngineTorque;

			IceEditBox*		mEditBox_WishboneWidth;
			IceEditBox*		mEditBox_WishboneHeight;
			IceEditBox*		mEditBox_WishboneLength;
			IceEditBox*		mEditBox_SuspStiffness;
			IceEditBox*		mEditBox_SuspDamping;
			IceEditBox*		mEditBox_SuspHeight;
			IceEditBox*		mEditBox_SuspLimitAngle;
			IceEditBox*		mEditBox_AttachWidth;
			IceEditBox*		mEditBox_AttachHeight;
			IceEditBox*		mEditBox_AttachLength;

			IceEditBox*		mEditBox_Friction;
			IceEditBox*		mEditBox_RCAFriction;
			IceEditBox*		mEditBox_Speed;
			IceEditBox*		mEditBox_InertiaCoeff;
			IceEditBox*		mEditBox_Multiplier;

			IceComboBox*	mComboBox_NbWheels;
			IceComboBox*	mComboBox_WheelType;
			IceComboBox*	mComboBox_DriveType;
			IceComboBox*	mComboBox_Suspension;
			IceComboBox*	mComboBox_EngineMode;
			IceComboBox*	mComboBox_Level;

			IceSlider*		mSteerSlider;
	...
	public:
							MultiBodyVehicle() :
								...
								mCheckBox_AttachCar				(null),
								mCheckBox_AttachWheels			(null),
								mCheckBox_AttachSteering		(null),
								mCheckBox_UseRCA				(null),
								mCheckBox_UseAggregates			(null),
								mCheckBox_TweakWheelsInertia	(null),
								mEditBox_GlobalScale			(null),
								mEditBox_CameraUpOffset			(null),
								mEditBox_CameraDistToTarget		(null),
								mEditBox_ChassisWidth			(null),
								mEditBox_ChassisHeight			(null),
								mEditBox_ChassisLength			(null),
								mEditBox_ChassisMass			(null),
								mEditBox_ChassisCOMOffsetX		(null),
								mEditBox_ChassisCOMOffsetY		(null),
								mEditBox_ChassisCOMOffsetZ		(null),
								mEditBox_MassElements			(null),
								mEditBox_ChassisFriction		(null),
								mEditBox_WheelMass				(null),
								mEditBox_WheelFrontFriction		(null),
//								mEditBox_WheelRearFriction		(null),
								mEditBox_WheelRadius			(null),
								mEditBox_WheelWidth				(null),
								mEditBox_WheelTessR				(null),
								mEditBox_WheelTessW				(null),
								mEditBox_SteerStiffness			(null),
								mEditBox_SteerDamping			(null),
								mEditBox_SteerLimitAngle		(null),
								mEditBox_EngineTorque			(null),
								mEditBox_WishboneWidth			(null),
								mEditBox_WishboneHeight			(null),
								mEditBox_WishboneLength			(null),
								mEditBox_SuspStiffness			(null),
								mEditBox_SuspDamping			(null),
								mEditBox_SuspHeight				(null),
								mEditBox_SuspLimitAngle			(null),
								mEditBox_AttachWidth			(null),
								mEditBox_AttachHeight			(null),
								mEditBox_AttachLength			(null),
								mEditBox_Friction				(null),
								mEditBox_RCAFriction			(null),
								mEditBox_Speed					(null),
								mEditBox_InertiaCoeff			(null),
								mEditBox_Multiplier				(null),
								mComboBox_NbWheels				(null),
								mComboBox_WheelType				(null),
								mComboBox_DriveType				(null),
								mComboBox_Suspension			(null),
								mComboBox_EngineMode			(null),
...
//		const Point WheelAttachExtents(0.5f, WheelAttachHeight, 0.1f);
		...
		if(WT==WHEEL_SPHERE_VISUAL_SPHERE || WT==WHEEL_SPHERE_VISUAL_CYLINDER)
		{
			...
			WC.mObjectDesc.mShapes			= &WC.mSphereDesc;
		}
...
//			WC.mConvexDesc.mMaterial	= IsFront ? &UserMaterial : &LowFrictionMaterial;
			WC.mObjectDesc.mShapes		= &WC.mConvexDesc;
		}
...
/*						ObjectDesc.mAddToWorld	= !Aggregate;
...

						{
							...
							fjc.mMinLimitAngle	= -LimitAngle;
							fjc.mMaxLimitAngle	= LimitAngle;
...
/*						PINT_CONVEX_CREATE WheelDesc(TotalNbVerts, Verts);
						...
						WC.mObjectDesc.mShapes				= &WheelDesc;*/
...
/*							ObjectDesc.mAddToWorld	= !Aggregate;
		...
		//						PintJointHandle j0 = pint.CreateJoint(fjc);
...

					{
						...
						fjc.mLocalPivot0 = Point(0.0f, 0.0f, -LeftLinkExtents.z);
						fjc.mLocalPivot1 = Point(0.0f, 0.0f, RackExtents.z);
//						PintJointHandle j0 = pint.CreateJoint(fjc);
							PINT_SPHERICAL_JOINT_CREATE* Copy = ICE_NEW(PINT_SPHERICAL_JOINT_CREATE)(fjc);
							Joints.AddPtr(Copy);
					}

					{
						...
						fjc.mObject1 = SteeringRackHandle;
						fjc.mLocalPivot0 = Point(0.0f, 0.0f, RightLinkExtents.z);
						fjc.mLocalPivot1 = Point(0.0f, 0.0f, -RackExtents.z);
//						PintJointHandle j0 = pint.CreateJoint(fjc);
							PINT_SPHERICAL_JOINT_CREATE* Copy = ICE_NEW(PINT_SPHERICAL_JOINT_CREATE)(fjc);
							Joints.AddPtr(Copy);
