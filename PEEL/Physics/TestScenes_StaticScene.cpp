...
static const char* gDesc_StaticMeshes = "(Configurable test) - Static mesh. Used to check memory usage and for raytracing tests.";

class StaticMesh : public TestBase
{
			IceComboBox*	mComboBox_Filename;
	public:
							StaticMesh() :
								mComboBox_Filename(null)
														{								}
	virtual					~StaticMesh()				{								}
...
static const char* gDesc_CustomerStaticMeshes = "(Configurable test) - Customer static mesh. Used to check memory usage and for raytracing tests.";
