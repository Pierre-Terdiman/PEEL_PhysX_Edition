...
TerrainStreamingUI::TerrainStreamingUI() :
	mCheckBox_DrawStreamingRegions			(null),
	mCheckBox_DrawVertexNormals				(null),
	mCheckBox_DrawWheelOverlapSpheres		(null),
	mCheckBox_DeformTerrain					(null),
	mCheckBox_CreateAllInitialTiles			(null),
	//
	mEditBox_StreamerWorldSize				(null),
	mEditBox_StreamerTilesPerSide			(null),
	mEditBox_StreamerVerticesPerSide		(null),
	mEditBox_StreamerNbAddedRegionsPerFrame	(null),
	mEditBox_WheelOverlapSphereRadius		(null)
{
}
