...
//		return null;
	...
	PxConvexMesh* ChassisMesh = CreateConvexMesh(ChassisDesc->mVerts, ChassisDesc->mNbVerts, PxConvexFlag::eCOMPUTE_CONVEX, vehicle.mChassis->mRenderer, mParams.mShareMeshData);
	ASSERT(ChassisMesh);

	const PINT_CONVEX_CREATE* WheelDesc0 = static_cast<const PINT_CONVEX_CREATE*>(vehicle.mWheels[0]);
	PxConvexMesh* WheelMesh0 = CreateConvexMesh(WheelDesc0->mVerts, WheelDesc0->mNbVerts, PxConvexFlag::eCOMPUTE_CONVEX, WheelDesc0->mRenderer, mParams.mShareMeshData);
	ASSERT(WheelMesh0);
	...
	if(vehicle.mWheels[1])
	{
		...
		WheelMesh1 = CreateConvexMesh(wheel1->mVerts, wheel1->mNbVerts, PxConvexFlag::eCOMPUTE_CONVEX, wheel1->mRenderer, mParams.mShareMeshData);
		ASSERT(WheelMesh1);
		...
		WheelMesh2 = CreateConvexMesh(wheel2->mVerts, wheel2->mNbVerts, PxConvexFlag::eCOMPUTE_CONVEX, wheel2->mRenderer, mParams.mShareMeshData);
		ASSERT(WheelMesh2);
		...
		WheelMesh3 = CreateConvexMesh(wheel3->mVerts, wheel3->mNbVerts, PxConvexFlag::eCOMPUTE_CONVEX, wheel3->mRenderer, mParams.mShareMeshData);
		ASSERT(WheelMesh3);
