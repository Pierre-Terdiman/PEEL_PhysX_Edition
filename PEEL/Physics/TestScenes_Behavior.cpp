...
static const char* gDesc_DominosConfigurable = "(Configurable test) - Dominos. Things to look for are whether the dominoes drift or not after they have all been knocked down. \
...
class DominosConfigurable : public TestBase
{
			...
			IceEditBox*		mEditBox_CircleRadius;
			IceEditBox*		mEditBox_NbPerCircle;
			IceEditBox*		mEditBox_ShrinkFactor;
			IceEditBox*		mEditBox_NbRounds;
			IceCheckBox*	mCheckBox_PushLine;
	public:
							DominosConfigurable() :
								mComboBox_Preset		(null),
								mEditBox_Friction		(null),
								mEditBox_CircleRadius	(null),
								mEditBox_NbPerCircle	(null),
								mEditBox_ShrinkFactor	(null),
								mEditBox_NbRounds		(null),
								mCheckBox_PushLine		(null)	{}
...
static const char* gDesc_CompoundTower = "Compound tower. Can you tweak the settings so that the tower doesn't collapse?";

START_TEST(CompoundTower, CATEGORY_BEHAVIOR, gDesc_CompoundTower)

	virtual	float	GetRenderData(Point& center)	const	{ return 400.0f;	}

/*	virtual	IceTabControl*	InitUI(PintGUIHelper& helper)
	{
		return CreateOverrideTabControl("CompoundTower", 20);
	}*/
...
END_TEST(CompoundTower)

static const char* gDesc_CompoundTowerTweaked = "Compound tower. Tweaked.";
