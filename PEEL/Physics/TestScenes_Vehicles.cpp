...
static const PINT_SHAPE_CREATE* FindChassis(const PINT_SHAPE_CREATE* create, const PINT_SHAPE_CREATE** wheels)
{
	const PINT_SHAPE_CREATE* Part0 = create;
	const PINT_SHAPE_CREATE* Part1 = Part0->mNext;
	const PINT_SHAPE_CREATE* Part2 = Part1->mNext;
	const PINT_SHAPE_CREATE* Part3 = Part2->mNext;
	const PINT_SHAPE_CREATE* Part4 = Part3->mNext;
...
class VehicleSDK : public VehicleInput
{
	public:
							VehicleSDK(VehicleScene default_scene=SCENE_RACE_TRACK) :
								...
								mCheckBox_UseRenderMeshes				(null),
								mCheckBox_ImmediateAutoReverse			(null),
								//
								mEditBox_VehicleScale					(null),
								mEditBox_CameraHeight					(null),
								mEditBox_CameraDist						(null),
								mEditBox_CameraSharpnessPos				(null),
								mEditBox_CameraSharpnessRot				(null),
								...
								mEditBox_WheelMaxHandBrakeTorqueFront	(null),
								mEditBox_WheelMaxHandBrakeTorqueRear	(null),
								mEditBox_WheelMaxSteerFront				(null),
								mEditBox_WheelMaxSteerRear				(null),
								mEditBox_AntirollBarStiffness			(null),
								mEditBox_TireFrictionMultiplierFront	(null),
								mEditBox_TireFrictionMultiplierRear		(null),
								mEditBox_Substeps						(null),
								...
								mEditBox_GroundClearanceCutOffset		(null),
								mEditBox_EngineMOI						(null),
								...
								mEditBox_FrontRearSplit					(null),
								mEditBox_FrontLeftRightSplit			(null),
								mEditBox_RearLeftRightSplit				(null),
								mEditBox_CentreBias						(null),
								mEditBox_FrontBias						(null),
								mEditBox_RearBias						(null),
								mEditBox_AckermannAccuracy				(null),
								mEditBox_ThresholdForwardSpeed			(null),
								mComboBox_Level							(null),
								mComboBox_Differential					(null),
								//
								mEditBox_RaceTrackSize					(null),
								mEditBox_RaceTrackAmplitude				(null),
								mEditBox_RaceTrackWidth					(null),
								mEditBox_RaceTrackWallHeight			(null)
														{
	...
	virtual	TestCategory	GetCategory()		const	{ return CATEGORY_VEHICLES;	}
			...
			IceCheckBox*		mCheckBox_UseRenderMeshes;
			IceCheckBox*		mCheckBox_ImmediateAutoReverse;
			IceEditBox*			mEditBox_VehicleScale;
			IceEditBox*			mEditBox_CameraHeight;
			IceEditBox*			mEditBox_CameraDist;
			IceEditBox*			mEditBox_CameraSharpnessPos;
			IceEditBox*			mEditBox_CameraSharpnessRot;
			...
			IceEditBox*			mEditBox_WheelMaxHandBrakeTorqueFront;
			IceEditBox*			mEditBox_WheelMaxHandBrakeTorqueRear;
			IceEditBox*			mEditBox_WheelMaxSteerFront;
			IceEditBox*			mEditBox_WheelMaxSteerRear;
			IceEditBox*			mEditBox_AntirollBarStiffness;
			IceEditBox*			mEditBox_TireFrictionMultiplierFront;
			IceEditBox*			mEditBox_TireFrictionMultiplierRear;
			IceEditBox*			mEditBox_Substeps;
			...
			IceEditBox*			mEditBox_GroundClearanceCutOffset;
			IceEditBox*			mEditBox_EngineMOI;
			...
			IceEditBox*			mEditBox_FrontRearSplit;
			IceEditBox*			mEditBox_FrontLeftRightSplit;
			IceEditBox*			mEditBox_RearLeftRightSplit;
			IceEditBox*			mEditBox_CentreBias;
			IceEditBox*			mEditBox_FrontBias;
			IceEditBox*			mEditBox_RearBias;
			IceEditBox*			mEditBox_SteeringSpeed[4];
			IceEditBox*			mEditBox_SteeringValue[4];
			IceEditBox*			mEditBox_SmoothingData[4*4];
			IceEditBox*			mEditBox_AckermannAccuracy;
			IceEditBox*			mEditBox_ThresholdForwardSpeed;
			IceComboBox*		mComboBox_Level;
			IceComboBox*		mComboBox_Differential;

			IceEditBox*			mEditBox_RaceTrackSize;
			IceEditBox*			mEditBox_RaceTrackAmplitude;
			IceEditBox*			mEditBox_RaceTrackWidth;
			IceEditBox*			mEditBox_RaceTrackWallHeight;
...
//		const char* Filename = FindPEELFile("NX_Vehicle.zb2");
		if(Filename)
		{
			...
			if(mZB2Factory)
			{
				...
				if(NbActors==1)
				{
					const PINT_OBJECT_CREATE* Create = (const PINT_OBJECT_CREATE*)mZB2Factory->mActors.GetEntry(0);
					const PINT_SHAPE_CREATE* Wheels[4];
					mChassis = FindChassis(Create->mShapes, Wheels);
