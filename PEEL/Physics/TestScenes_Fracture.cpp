...
static const char* gDesc_VoronoiFracture2 = "Runtime fracture. Press SHIFT + left mouse button to fracture the object.";
...
class VoronoiFracture2 : public TestBase, public PintContactNotifyCallback
{
			...
			IceEditBox*		mEditBox_NbCells;
			IceEditBox*		mEditBox_BiasExp;
			IceEditBox*		mEditBox_SizeX;
			IceEditBox*		mEditBox_SizeY;
			IceEditBox*		mEditBox_SizeZ;
			IceEditBox*		mEditBox_MinSize;
			IceCheckBox*	mCheckBox_Kinematic;
	public:
							VoronoiFracture2() :
								mComboBox_ConvexIndex(null),
									mEditBox_NbCells(null),
									mEditBox_BiasExp(null),
									mEditBox_SizeX(null),
									mEditBox_SizeY(null),
									mEditBox_SizeZ(null),
									mEditBox_MinSize(null),
									mCheckBox_Kinematic(null)
								{}
...
static const char* gDesc_VoronoiFracture3 = "Fracturable box stack. Press SHIFT + left mouse button to fracture objects.";
