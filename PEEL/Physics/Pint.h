...
#include "PintSurfaceInterface.h"
	...
	{
				PintCameraPose()															{ mPos = Point(50.0f, 50.0f, 50.0f); mDir = Point(-0.6f, -0.2f, -0.7f);	}
...
//		inline	const char*			GetTestDesc()	const	{ return mTestDesc;	}
	...
	{
									PINT_SPHERICAL_JOINT_CREATE() : PINT_JOINT_CREATE(PINT_JOINT_SPHERICAL)
									{
										mLocalPivot0.Zero();
										mLocalPivot1.Zero();
									}
									PINT_SPHERICAL_JOINT_CREATE(PintActorHandle object0, PintActorHandle object1, const Point& p0, const Point& p1) : PINT_JOINT_CREATE(PINT_JOINT_SPHERICAL)
									{
										mLocalPivot0 = p0;
										mLocalPivot1 = p1;
										mObject0 = object0;
	...
	{
									PINT_HINGE_JOINT_CREATE() : PINT_JOINT_CREATE(PINT_JOINT_HINGE)
									{
										mLocalPivot0.Zero();
										mLocalPivot1.Zero();
										mLocalAxis0.Zero();
	...
	{
									PINT_HINGE2_JOINT_CREATE() : PINT_JOINT_CREATE(PINT_JOINT_HINGE2)
									{
	...
	{
									PINT_DISTANCE_JOINT_CREATE() : PINT_JOINT_CREATE(PINT_JOINT_DISTANCE)
									{
										mLocalPivot0.Zero();
										mLocalPivot1.Zero();
										mMinDistance = -1.0f;
...
//		virtual	void				SetRCArticulatedMotor(PintActorHandle object, const PINT_ARTICULATED_MOTOR_CREATE& motor)									{ NotImplemented("SetRCArticulatedMotor");						}
		...
		// Joints - WIP
		virtual	bool				GetHingeInfo(PintJointHandle handle, PintHingeInfo& info)							{ return NotImplemented("GetHingeInfo");				}
		virtual	bool				GetD6Info(PintJointHandle handle, PintD6Info& info)									{ return NotImplemented("GetD6Info");					}
...
//		virtual	Point				GetGravity(/*PintSceneHandle handle*/)	const					{ mPint.NotImplemented("Pint_Scene::GetGravity");	return Point(0.0f, 0.0f, 0.0f);	}
	...
	class Pint_Joint : public Allocateable
	{
		...
		virtual	bool				GetFrames(PintJointHandle handle, PR& frame0, PR& frame1)		const	{ return mPint.NotImplemented("Pint_Joint::GetFrames");	}
