...
static const float gGlobalScale = 0.1f;
...
/*					if(i==NbVerts-1)
					...
					ctx->mCurrentMesh->mVertices.AddVertex(x*gGlobalScale, y*gGlobalScale, z*gGlobalScale);
				}
			}
			else
			{
...
//		ASSERT(det==1.0f);
		...
		ctx->mCurrentActor->mPose.SetTrans(Point(Values[3]*gGlobalScale, Values[7]*gGlobalScale, Values[11]*gGlobalScale));
	}
...
static bool LoadLegoFile(udword id, const char* name)
{
...
bool InitLegoLib(const char* filename)
{
//	return false;
	...
	LoadLegoFile(2432, "2432.obj");
	LoadLegoFile(3001, "3001.obj");
	LoadLegoFile(3004, "3004.obj");
	LoadLegoFile(3005, "3005.obj");
	LoadLegoFile(3009, "3009.obj");
	LoadLegoFile(3010, "3010.obj");
	LoadLegoFile(3024, "3024.obj");
	LoadLegoFile(3070, "3070.obj");
	LoadLegoFile(3622, "3622.obj");
	LoadLegoFile(11208, "11208.obj");
	LoadLegoFile(15068, "15068.obj");
	LoadLegoFile(18892, "18892.obj");
	LoadLegoFile(22889, "22889.obj");
	LoadLegoFile(24309, "24309.obj");
	LoadLegoFile(28324, "28324.obj");
	LoadLegoFile(30363, "30363.obj");
	LoadLegoFile(30414, "30414.obj");
	LoadLegoFile(50745, "50745.obj");
	LoadLegoFile(50950, "50950.obj");
	LoadLegoFile(57783, "57783.obj");
	LoadLegoFile(58090, "58090.obj");
	LoadLegoFile(60477, "60477.obj");
	printf("Done (%d parts).\n", GetNbLegoParts());
