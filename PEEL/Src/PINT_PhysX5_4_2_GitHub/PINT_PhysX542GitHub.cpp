...
// This one is for the official 5.4.2 GitHub release

#include "stdafx.h"
#include "PINT_PhysX542GitHub.h"
...
//	#pragma comment(lib, "../../Ice/Lib64/IML64.lib")
				...
				#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/profile/PhysX_64.lib")
				#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/profile/PhysXCommon_64.lib")
				#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/profile/PhysXCooking_64.lib")
				#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/profile/PhysXVehicle_static_64.lib")
				#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/profile/PhysXFoundation_64.lib")
				#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/profile/PhysXExtensions_static_64.lib")
				#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/profile/PhysXCharacterKinematic_static_64.lib")
				//#ifdef USE_NEW_PVD
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/profile/PhysXPvdSDK_static_64.lib")
				//#endif
			#endif
		#else
			#ifdef _DEBUG
				#ifndef USE_LOAD_LIBRARY
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/debug/PhysX_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXCommon_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXCooking_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXVehicle_static_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXCharacterKinematic_static_64.lib")
					//#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXGpu_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXFoundation_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXExtensions_static_64.lib")
					//#ifdef USE_NEW_PVD
						#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXPvdSDK_static_64.lib")
					//#endif
				#endif
			#else
				#ifndef USE_LOAD_LIBRARY
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/release/PhysX_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/release/PhysXCommon_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/release/PhysXCooking_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/release/PhysXVehicle_static_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/release/PhysXFoundation_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/release/PhysXExtensions_static_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/release/PhysXCharacterKinematic_static_64.lib")
					#ifdef USE_NEW_PVD
						#pragma comment(lib, "../../../../PEEL_Externals/5_4_2_GitHub/bin/win.x86_64.vc142.mt/release/PhysXPvdSDK_static_64.lib")
					#endif
				#endif
			#endif
		#endif
...
#ifdef PINT_SUPPORT_PVD
	return _F("PhysX 5.4.2 (GitHub/PVD) (%dT)", Suffix);
#else
	return _F("PhysX 5.4.2 (GitHub) (%dT)", Suffix);
#endif
}
...
{
#ifdef PINT_SUPPORT_PVD
	return "PhysX 5.4.2 (GitHub/PVD)";
#else
	return "PhysX 5.4.2 (GitHub)";
#endif
}
...
udword PhysX_CQS::FindTriangles_MeshMeshOverlap(PintSQThreadContext context, PintActorHandle handle0, PintActorHandle handle1, Container& results)
{
	...
	PxTriangleMeshGeometry meshGeom0 = static_cast<const PxTriangleMeshGeometry&>(Shape0->getGeometry());
	PxTriangleMeshGeometry meshGeom1 = static_cast<const PxTriangleMeshGeometry&>(Shape1->getGeometry());
#else
...
void PhysX_Init(const PINT_WORLD_CREATE& desc)
{
	...
	ASSERT(!gPhysX);
	gPhysX = ICE_NEW(PhysX_CQS)(PhysX3::GetEditableParams(), desc.GetTestName());
	gPhysX->Init(desc);
}
...
const char*	PhysXPlugIn::GetTestGUIName()									{ return "PhysX 5.4.2 (GitHub)";		}
