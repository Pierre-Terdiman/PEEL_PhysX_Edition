...
// This one is for the official 5.6.0 GitHub release

#include "stdafx.h"
#include "PINT_PhysX560GitHub.h"
...
//	#pragma comment(lib, "../../Ice/Lib64/IML64.lib")
				...
				#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/profile/PhysX_64.lib")
				#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/profile/PhysXCommon_64.lib")
				#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/profile/PhysXCooking_64.lib")
				#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/profile/PhysXFoundation_64.lib")
				#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/profile/PhysXExtensions_static_64.lib")
				#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/profile/PhysXCharacterKinematic_static_64.lib")
				//#ifdef USE_NEW_PVD
					#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/profile/PhysXPvdSDK_static_64.lib")
				//#endif
			#endif
		#else
			#ifdef _DEBUG
				#ifndef USE_LOAD_LIBRARY
					#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/debug/PhysX_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXCommon_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXCooking_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXCharacterKinematic_static_64.lib")
					//#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXGpu_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXFoundation_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXExtensions_static_64.lib")
					//#ifdef USE_NEW_PVD
						#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/debug/PhysXPvdSDK_static_64.lib")
					//#endif
				#endif
			#else
				#ifndef USE_LOAD_LIBRARY
					#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/release/PhysX_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/release/PhysXCommon_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/release/PhysXCooking_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/release/PhysXFoundation_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/release/PhysXExtensions_static_64.lib")
					#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/release/PhysXCharacterKinematic_static_64.lib")
					#ifdef USE_NEW_PVD
						#pragma comment(lib, "../../../../PEEL_Externals/5_6_0_GitHub/bin/win.x86_64.vc142.mt/release/PhysXPvdSDK_static_64.lib")
					#endif
				#endif
			#endif
		#endif
...
#ifdef PINT_SUPPORT_PVD
	return _F("PhysX 5.6.0 (GitHub/PVD) (%dT)", Suffix);
#else
	return _F("PhysX 5.6.0 (GitHub) (%dT)", Suffix);
#endif
}
...
{
#ifdef PINT_SUPPORT_PVD
	return "PhysX 5.6.0 (GitHub/PVD)";
#else
	return "PhysX 5.6.0 (GitHub)";
#endif
}
...
const char*	PhysXPlugIn::GetTestGUIName()									{ return "PhysX 5.6.0 (GitHub)";		}
